...
**What this project says about me as an AI engineer** — I gravitate toward systems where the AI earns trust rather than assumes it: every design choice here — showing sources, requiring explicit opt-in for general knowledge, logging the scheduler's reasoning — reflects a belief that transparency is a feature, not an afterthought. I'm drawn to the seam between deterministic logic and learned models, and I think carefully about which problems actually need AI and which are better solved with clear rules. I learn best by building end-to-end and letting real usage surface the gaps that abstract design never reveals. Most of all, I care about the person on the other end: a pet owner reading a confident wrong answer about their dog's medication is the failure mode I was designing against the entire time.
